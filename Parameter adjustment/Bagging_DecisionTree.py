...
# Dicision Tree
dcTree = tree.DecisionTreeClassifier(criterion = 'entropy',splitter = 'random')
...
plot_confusion_matrix(cnf_matrix, classes=class_names, normalize=True,
                      title='Normalized Confusion Matrix for Bagging Decision Tree')
...
print(
    'Bagging Decision Tree accuracy: {0}, Bagging Decision Tree precision: {1}, Bagging Decision Tree recall: {2}, Bagging Decision Tree Fscore: {3}'.format(
        accuracy, metric[0], metric[1], metric[2]))
